# Angular4 MEAN Stack Boilerplate - with ExpressJS, MongoDB, Gulp and Typescript
...
1.  Angular 4 Quick Start application (Tours of Hero) from https://angular.io/docs/ts/latest/quickstart.html
